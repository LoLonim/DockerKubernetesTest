# Описание приложения
Данное приложение выводит список файлов в папке App на сервере, запущенном из Docker контейнера. Оно было запаковано в Docker контейнер и на его основе был создан pod manifest для kubernetes. Использованы Java spring web, thymeleaf, Docker, minikube. Далее описаны все проделанные действия.
# Docker
## Шаг 1
